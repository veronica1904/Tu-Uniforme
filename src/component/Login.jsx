...
import { loginGoogle } from '../redux/action/actionLogin';
...
const useStyles = makeStyles((theme) => ({
    root: {
        ...
        background: 'url(https://res.cloudinary.com/veronicaduque/image/upload/v1651710958/tu%20uniforme/kids-vectorf_j1ojra.jpg) center center no-repeat',
        height: '100vh',
        display: 'flex',
